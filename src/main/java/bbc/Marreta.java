...
public class Marreta extends AdvancedRobot {
    ...
    public static String RULES_FILE = "bbc/rules/robot_rules.drl";
...
//        	turnRadarRight(360);
    ...
    private void createKnowledgeBase() {
        String rulesFile = System.getProperty("robot.rules", Marreta.RULES_FILE);

        DEBUG.message("Creating knowledge base");
        kbuilder = KnowledgeBuilderFactory.newKnowledgeBuilder();
        
        DEBUG.message("Loading rules since "+rulesFile);
        kbuilder.add(ResourceFactory.newClassPathResource(rulesFile, Marreta.class), ResourceType.DRL);
    ...
    private Vector<Action> loadActions() {
        ...
        for (QueryResultsRow result : ksession.getQueryResults(Marreta.CONSULT_ACTIONS)) {
